    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      ...
      >
        ...
        <p className="mt-6 text-sm leading-relaxed text-muted-foreground">
          {IS_OPEN
            ? "This preview is unlocked — no passphrase required. Continue to view the document."
...
<label className="block">
            ...
            <input
              ...
              autoFocus={!IS_OPEN}
              // In preview mode the field is shown for reference only, so it
              // must not block submission when left empty.
              required={!IS_OPEN}
              placeholder="••••••••••••"
